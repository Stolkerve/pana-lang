...
impl Lexer {
    ...
    pub fn next_token(&mut self) -> Token {
        ...
        match self.current_char {
            ...
            '-' => Token::new(TokenType::Sub, self.line, self.col),
            '/' => Token::new(TokenType::Div, self.line, self.col),
            '*' => Token::new(TokenType::Mul, self.line, self.col),
            '!' => self.read_2chars_token('=', TokenType::NotEq, TokenType::Not),
